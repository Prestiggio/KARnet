...
La Plateforme dépose uniquement les cookies strictement nécessaires à son fonctionnement : session de connexion, identification de l'espace paroissial consulté, langue d'affichage choisie, protection contre la falsification de requête.

Ces cookies sont exemptés de consentement préalable, conformément à l'article 82 de la loi n° 78-17 modifiée et aux lignes directrices applicables en matière de traceurs.

La mesure d'audience est assurée par Umami, un outil libre installé sur notre propre infrastructure. Aucune donnée n'est transmise à un tiers.

Umami ne dépose aucun cookie et ne crée aucun identifiant persistant. Il ne permet ni le suivi d'un visiteur entre plusieurs sessions, ni le suivi entre sites, ni la constitution de profils. Les adresses IP ne sont pas conservées : elles servent uniquement, de manière transitoire et sous forme irréversible, à distinguer les sessions d'une même journée.

Les statistiques produites sont exclusivement agrégées : pages consultées, provenance du trafic, type de terminal, pays, indicateurs de performance d'affichage. Elles ne permettent pas de vous identifier.

Cette configuration ne requiert pas votre consentement préalable et ne nécessite aucun mécanisme d'opposition, aucune donnée personnelle n'étant traitée à cette fin.
