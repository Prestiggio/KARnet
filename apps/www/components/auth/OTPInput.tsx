...
export default function OTPInput() {
    ...
    return <>
        <div className="hidden text-sm text-gray-400">{__('Jereo ihany anaty spam raha tsy voaray afaka 1 minitra')}</div>
        <button type="button" className="hidden text-sm cursor-pointer hover:underline">
            {__(`Raha tsy voaray ny mail de potsero eto averinay alefa`)}
        </button>
